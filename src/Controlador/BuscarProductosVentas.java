...
public class BuscarProductosVentas extends javax.swing.JInternalFrame {
    ...
    private void listar() {
        tbProductos.setModel(CP.CargarDatosBusqueda());
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setPreferredSize(new java.awt.Dimension(610, 373));
        ...
        rbtDescripcion.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(rbtDescripcion);
        rbtDescripcion.setBounds(70, 220, 0, 15);
        ...
        jPanel1.setBounds(17, 11, 490, 70);
        ...
        jScrollPane3.setBounds(10, 87, 574, 190);
        ...
        btnAgregar.setBounds(0, 280, 78, 47);
        ...
        btnRegresar.setBounds(510, 280, 84, 44);
        ...
        btnCancelar1.setBounds(510, 10, 81, 75);
...
private void mnenviarproActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnenviarproActionPerformed
    ...
    private void tbProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbProductosMouseClicked
        ...
        Ventas.txtCodigoProducto.setText(tbProductos.getValueAt(row, 0).toString());
        Ventas.txtNombreProducto.setText(tbProductos.getValueAt(row, 2).toString());
        Ventas.txtCategoria.setText(tbProductos.getValueAt(row, 1).toString());
        Ventas.txtCosto.setText(tbProductos.getValueAt(row, 5).toString());
    ...
    private void btnCancelar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelar1ActionPerformed
      Ventas.txtCodigoProducto.setText("");
        Ventas.txtNombreProducto.setText("");
        Ventas.txtCategoria.setText("");
        Ventas.txtStockProducto.setText("");
        Ventas.txtPrecioProducto.setText("");
        Ventas.txtDescripcionProducto.setText("");
        Ventas.btnBuscarProducto.requestFocus();
    ...
    void BuscarProductos(){
        String titulos[]={"ID","Presentación","Descripción","Concentración","Stock","Costo","Venta"};
